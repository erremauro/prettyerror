 ...
 * @property {Function} describe Fromat SolidErrors' description message
 */
...
/**
 * Format SolidError's description message.
...
/**
 * Format SolidError's explanation message.
...
/**
 * Format SolidError's example message.
 *
...
/**
 * Format SolidError's footer message.
...
/**
 * Format SolidError's header message.
...
function fmtHeader( errHeader ) {
  var headerTitle = errHeader ?
    options.headerTitle + ': ' + errHeader :
    options.headerTitle
  return options.header( getDivider( headerTitle, options.headerStyle ) )
}

/**
 * Format SolidError's stack trace.
 *
 * @function
