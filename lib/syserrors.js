 ...
 * {module:solidError~SolidErrorProps|option included} dirctories.
 * @return {string[]} Language aware directory path
 * @version 0.1.0
 * @since 0.1.0
 */
 ...
 * @memberOf module:lib/solidError
...
function unexpectedError( innerError ) {
  var errProps = {
    ...
    describe: 'This operation cannot be completed due to an unexpected error.',
